...
//        WatchingVideoResponse watchingVideoResponse = WatchingVideoResponse.builder()
//            .views(10000L)
...
//            .build();
//
//        given(videoService.startWatchingVideo(videoId)).willReturn(watchingVideoResponse);
