...
public class VideoResponse {
    ...
    @Schema(name = "userId", description = "동영상 소유주 식별 정보", example = "hongkildong", requiredMode = Schema.RequiredMode.REQUIRED)
    private Long userId;

    @Schema(name = "videoUrl", description = "동영상 파일 경로", requiredMode = Schema.RequiredMode.REQUIRED)
    private String videoUrl;

    @Schema(name = "thumbnailUrl", description = "썸네일 파일 경로", requiredMode = Schema.RequiredMode.REQUIRED)
    private String thumbnailUrl;

    @Schema(name = "views", description = "동영상 총 시청 횟수", example = "1000", requiredMode = Schema.RequiredMode.REQUIRED)
    private Long views;
