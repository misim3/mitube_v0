...
public class CreateCommentRequest implements Checker {
    ...
    @Schema(name = "videoId", description = "댓글을 생성할 동영상 식별 정보", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
    private Long videoId;

    @Schema(name = "userId", description = "댓글 작성자 식별 정보", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
    private Long userId;

    @Schema(name = "parentCommentId", description = "대댓글의 경우, 댓글의 식별 정보", example = "2", requiredMode = Schema.RequiredMode.REQUIRED)
